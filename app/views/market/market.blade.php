...
<head>
	...
	{{ HTML::style('assets/css/common_a.css') }}
...
<body>
	...
	<table style='margin-left:35px;'>
		<tr>
			...
			<td>
				<span id="broadcast_button"><img src='../public/assets/images/send.png' /></span>
			</td>
		</tr>
	</table>
</div>
<div class="panel rightpanel">
	<div id='logot'><a id='logout' href='#' title='logout'><img src='../public/assets/images/icons/logout.png' class='smoothbig' width='50' heigth='50'/></a></div>
	<div id='leaderboard'><a id='leader' href='lb2/scrolloffame.html' class='smoothbig' title='Leaderboard' target='_blank'><img src='../public/assets/images/icons/leaderboard.png' class='smoothbig' width='50' heigth='50'/></a></div>
	<div id='st'><a id='story' href='game.php'><img src='../public/assets/images/icons/story.png' title='story' width='50' heigth='50' class='smoothbig'/></a></div>					


</div>
<div >
	<a id='shop' href="#"><img src='../public/assets/images/market_hover.png' ></a>
</div>
...
<img class="animateopacity" src="../public/assets/images/logo.png" style="position:fixed;bottom:50px;left:30px;" title="copyright - Software Incubator 2013"/>
</body>
